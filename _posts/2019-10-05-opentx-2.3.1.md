...
___
**WARNINGS: X9D owners:**
due to an issue with RS slider missing in 2.3.1, downloads of X9D version of 2.3.1 is currently suspended.. Please note that this applies ONLY to the X9D original model from 2013, not the X9D+, not the X9D 2019 either
___
