...
- Companion will crash when flashing a Taranis if the splash screen is set to anythign other than "Use firmware start screen". Use an older companion version to flash or skip on changing the splash.
