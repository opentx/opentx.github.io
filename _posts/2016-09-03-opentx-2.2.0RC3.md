...
We are happy to release the third release candidate of OpenTX 2.2.0, with support for the production version of the FrSky Horus radio!
...
- Fix mexer edit page on Taranis
- Speed up Horus model selection screen
- Capibrating the 6-position switch on Horus does not require waiting as long between positions

Download links:

[OpenTX Companion 2.2.0 RC3 (N353) - Windows Installer](http://downloads.open-tx.org/2.2/nightly/companion/windows/companion-windows-2.2.0N353.exe)

OpenTX Companion 2.2.0 RC3 (N353) - Linux DEB Package [64-bit](http://downloads.open-tx.org/2.2/nightly/companion/linux/companion22_2.2.0N353_amd64.deb)
