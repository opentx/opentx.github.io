...
We are happy to bring you the release version of OpenTX 2.3.0RC2, with support for the production version of the FrSky Xlite-Pro, FrSky X9 Lite, FrSky x10 Express, FrSky X9D+2019 and Jumper T12 radios!
...
[SDCard](http://downloads.open-tx.org/2.3/rc/sdcard/) content for 2.3.0RC2

Note: 2.3.0RC2 uses 2.3v0021.
Changes vs 2.2:
...
[OpenTX Companion 2.3.0RC2  - Windows Installer](http://downloads.open-tx.org/2.3/rc/companion/windows/companion-windows-2.3.0RC2.exe)
...
[OpenTX Companion 2.3.0RC2  - Mac OS X Disk Image](http://downloads.open-tx.org/2.3/rc/companion/macosx/opentx-companion-2.3.0RC2.dmg)

[OpenTX Companion 2.3.0RC2  - Linux DEB Package 64-bit](http://downloads.open-tx.org/2.3/rc/companion/linux/companion23_2.3.0RC2_amd64.deb)
