...
- When creating a new model, both modules are now defaulted "OFF"
...
- fix 1bit bitmap draw on 1287 displays
...
[SDCard](http://downloads.open-tx.org/2.3/sdcard/) content for 2.3.0RC1
...
[OpenTX Companion 2.3.0RC1  - Windows Installer](http://downloads.open-tx.org/2.3/companion/windows/companion-windows-2.3.0RC1.exe)
...
[OpenTX Companion 2.3.0RC1  - Mac OS X Disk Image](http://downloads.open-tx.org/2.3/companion/macosx/opentx-companion-2.3.0RC1.dmg)

OpenTX Companion 2.3.0RC1  - Linux DEB Package [64-bit](http://downloads.open-tx.org/2.3/companion/linux/companion22_2.3.0RC1_amd64.deb)

OpenTX Companion 2.3.0RC1 - Ubuntu [PPA](https://launchpad.net/~opentx-test/+archive/ubuntu/rel) (Trusty, Xenial and Yakkety, i386 and amd64)
