...
- Several radio : fix a freeze when volume was set to 0 while bgmusic was playing
- FrSky Xlite : improve PWM reading latency
- FrSky X7/Xlite : display stick type in analog screen
