...
- This release is the first one to increment sdcard version. If you get "wreong file version", you need to update yuour sdcard content with the files located : http://downloads.open-tx.org/2.2/nightly/sdcard/
...
- a lot event have been added to lua (not lua widgets)
