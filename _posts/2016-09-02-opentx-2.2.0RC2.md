...
- Fix flickering backlight on production Horus radios
- Fix GPS telemetry sensor handling
- Fix Companion crash when changing splash screen in Taranis firmware

Download links:

[OpenTX Companion 2.2.0 RC2 (N352) - Windows Installer](http://downloads.open-tx.org/2.2/nightly/companion/windows/companion-windows-2.2.0N352.exe)

OpenTX Companion 2.2.0 RC2 (N352) - Linux DEB Package [64-bit](http://downloads.open-tx.org/2.2/nightly/companion/linux/companion22_2.2.0N352_amd64.deb)
